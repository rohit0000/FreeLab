package com.example.rohit.freelab2.adapter;
...
import com.example.rohit.freelab2.R;
...
public class MyArrayAdapter extends ArrayAdapter<MyDataModel> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        vh.textViewName.setText(item.getDay());
        vh.textViewCountry.setText(item.getTimeSlot());
